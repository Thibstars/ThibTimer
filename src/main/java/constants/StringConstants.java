...
public final class StringConstants {
    ...
    public static final String TIMER_FORMAT = "00:00:00";
    public static final String TIMER_DELIMITER = ":";
    public static final String TIMER_EXTENDED_DELIMITER = " : ";

    public static final String LANGUAGE_BUNDLE_BASE_NAME = "LanguageBundle";
